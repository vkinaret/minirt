...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/07 21:08:50 by vkinaret          #+#    #+#             */
/*   Updated: 2024/11/07 21:08:52 by vkinaret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double	caps_intersection(t_p3 o, t_p3 d, t_figures *lst)
{
	...
	id1 = solve_surface(o, d, lst->fig.cy.c, lst->fig.cy.nv);
	id2 = solve_surface(o, d, c2, lst->fig.cy.nv);
