...
LIBFT = ./LIBFT/libft.a
SRC = main.c init.c init_color.c init_coords.c error.c parse.c parse_utils.c parse_camera.c parse_light.c parse_cylinder.c parse_sphere.c parse_plane.c render.c
OBJ = ${SRC:.c=.o}
